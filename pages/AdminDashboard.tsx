                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                <label className="block text-sm font-bold mb-4">Altezza Logo Navbar (px): {localSettings.logo_height}</label>
                                ...
                                <div className="flex gap-2 mb-6">
                                    <button onClick={() => setLocalSettings({...localSettings, logo_alignment: 'left'})} className={`flex-1 py-2 rounded-lg border font-bold flex items-center justify-center gap-2 ${localSettings.logo_alignment === 'left' ? 'bg-brand-600 text-white border-brand-600' : 'bg-white text-gray-500 hover:border-gray-300'}`}><AlignLeft className="h-4 w-4"/> Sinistra</button>
                                    <button onClick={() => setLocalSettings({...localSettings, logo_alignment: 'center'})} className={`flex-1 py-2 rounded-lg border font-bold flex items-center justify-center gap-2 ${localSettings.logo_alignment === 'center' ? 'bg-brand-600 text-white border-brand-600' : 'bg-white text-gray-500 hover:border-gray-300'}`}><AlignCenter className="h-4 w-4"/> Centro</button>
                                </div>
